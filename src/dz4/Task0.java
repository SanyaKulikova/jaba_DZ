...
public class Task0 {
    public static void main(String[] args) {
        ...
        if (string6.contains("М")) System.out.println("Да");
        if (string6.contains("M")) System.out.println("Да"); // чувствителен к языку
        else System.out.println("Нетушки");
        if (string6.contains("а")) System.out.println("Да"); // и к регистру тоже
        else System.out.println("Нетушки");
