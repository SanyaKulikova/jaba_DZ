...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String, Long> map = transactionStream // создаем что просят
        ...
        // toMap:
        // 1) keyMapper - функция по которой ключи формируются (номер аккаунта у нас )
        // 2) valueMapper - функция по которой формируются значения
        // 3) что делать если ключи одинаковые: складывать (мы же хотим всю всю сумму)
        System.out.println(map);



        //  2. найти сумму по всем аккаунтам
        ...
        long transactionsSum = transactionStream
                ...
                // преобразуем в числоывой поток на основе баланса
                .sum();
